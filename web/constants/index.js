...
export const OAUTH_REDIRECT_URI = process.env.NODE_ENV == 'production' ? 'https://www.setblocks.com/api/v/1/github-oauth' : 'https://416690df.ngrok.io/api/v/1/github-oauth'
