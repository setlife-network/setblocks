...
export const OAUTH_REDIRECT_URI = process.env.NODE_ENV == 'production' ? 'https://www.setblocks.com/api/v/1/github-oauth' : 'https://8a7f588c.ngrok.io/api/v/1/github-oauth'
